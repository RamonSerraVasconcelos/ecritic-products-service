...
public class FindByProductAndItemGateway implements FindByProductAndItemBoundary {
    ...
    @Override
    public Optional<Item> execute(Long productId, Long itemId) {
        ItemEntity itemEntity = itemEntityRepository.findByProductIdAndId(productId, itemId);
