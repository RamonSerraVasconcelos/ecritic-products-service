...
public interface ItemEntityRepository extends JpaRepository<ItemEntity, Long>, ItemEntityCustomRepository {

    ItemEntity findBySku(String sku);

    ItemEntity findByProductIdAndId(Long productId, Long id);
}
